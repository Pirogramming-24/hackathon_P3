...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        sessions_data = [
            ...
            {'title': '2026.01.06(화)', 'date': date(2026, 1, 6)},
            {'title': '2026.01.08(목) 오전', 'date': date(2026, 1, 8)},
            {'title': '2026.01.08(목) 오후', 'date': date(2026, 1, 8)},
            {'title': '2026.01.10(토) 오전', 'date': date(2026, 1, 10)},
            {'title': '2026.01.10(토) 오후', 'date': date(2026, 1, 10)},
            {'title': '2026.01.13(화) 오전', 'date': date(2026, 1, 13)},
            {'title': '2026.01.13(화) 오후', 'date': date(2026, 1, 13)},
            {'title': '2026.01.15(목) 오전', 'date': date(2026, 1, 15)},
            {'title': '2026.01.15(목) 오후', 'date': date(2026, 1, 15)},
            {'title': '2026.01.17(토)', 'date': date(2026, 1, 17)},
            {'title': '2026.01.20(화)', 'date': date(2026, 1, 20)},
            {'title': '2026.01.22(목)', 'date': date(2026, 1, 22)},
            {'title': '2026.01.24(토)', 'date': date(2026, 1, 24)},
        ]
